                    ...
                    <form method="POST" action="{{ route('clientes.store') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="md:col-span-2 flex items-center mt-2">
                                <input
                                    ...
                                    type="checkbox"
                                    value="1"
                                    class="rounded border-slate-700 bg-slate-900 text-emerald-500 shadow-sm focus:ring-emerald-500 focus:ring-offset-0"
                        ...
                        <div class="mt-6 flex justify-end space-x-3">
                            <a href="{{ route('clientes.index') }}"
                               class="inline-flex items-center px-4 py-2 bg-slate-800 border border-slate-600 rounded-md font-semibold text-xs text-slate-100 uppercase tracking-widest hover:bg-slate-700 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 focus:ring-offset-slate-950">
                                Cancelar
                            </a>
