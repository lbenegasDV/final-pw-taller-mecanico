                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <select id="cliente_id" name="cliente_id"
                                    ...
                                    @foreach($clientes as $cliente)
                                        <option value="{{ $cliente->id }}"
                                            @selected(old('cliente_id', $vehiculo->cliente_id) == $cliente->id)>
                            ...
                            <div>
                                ...
                                <x-text-input id="patente" name="patente" type="text"
                                              class="mt-1 block w-full"
                                              :value="old('patente', $vehiculo->patente)" required />
                            ...
                            <div>
                                ...
                                <select id="tipo" name="tipo"
                                        class="mt-1 block w-full rounded-md border-slate-700 bg-slate-950 text-slate-100 shadow-sm focus:border-emerald-500 focus:ring-emerald-500">
                                    <option value="auto" @selected(old('tipo', $vehiculo->tipo) === 'auto')>Auto</option>
                                    <option value="moto" @selected(old('tipo', $vehiculo->tipo) === 'moto')>Moto</option>
                                    <option value="camioneta" @selected(old('tipo', $vehiculo->tipo) === 'camioneta')>Camioneta</option>
                                </select>
