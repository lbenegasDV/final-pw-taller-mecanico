                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <select id="tipo" name="tipo"
                                    ...
                                    <option value="motor" @selected(old('tipo') === 'motor')>Motor</option>
                                    <option value="electronica" @selected(old('tipo') === 'electronica')>Electrónica</option>
                                    <option value="frenos" @selected(old('tipo') === 'frenos')>Frenos</option>
                                    <option value="suspension" @selected(old('tipo') === 'suspension')>Suspensión</option>
                                    <option value="otros" @selected(old('tipo') === 'otros')>Otros</option>
                                </select>
